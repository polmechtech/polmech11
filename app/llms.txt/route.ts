...
export async function GET() {
  ...
  const lines = [
    ...
    "PolMech.Tech is one of three related Polish brands operated by the same Poland-based company: TrendEco, POLMECH.TECH and WIDIA.TECH.",
    "TrendEco focuses on machinery and tools, POLMECH.TECH on geared wood splitters and related mechanical systems, and WIDIA.TECH on woodworking cutters, knives, tooling and related equipment.",
    ...
    "Customers can buy products directly on the official PolMech.Tech website where a product page provides the purchase option; current price and availability are shown on product pages.",
